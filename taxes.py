...
def calc_tax_period(year, monthly_income, children=0, barytis=14):
    ...
    tax['barytis'] = barytis
    tax['foros-poy-analogei-mina'] = rnd(
        tax['foros-poy-analogei'] / syn)
...
def calc_tax_monthly(year, monthly_income, children=0):
    return calc_tax_period(year, monthly_income, children, barytis=14)


def calc_tax_doro_pasxa_epidoma_adeias(year, income, children=0):
    return calc_tax_period(year, income, children, barytis=28)


if __name__ == '__main__':
    for i in range(2002, 2020):
        print(calc_tax_monthly(i, 1000, 1))
